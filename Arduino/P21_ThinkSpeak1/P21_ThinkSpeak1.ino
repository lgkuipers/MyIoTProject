...
#define ThingSpeakKEY "C9MTOOT9U6R0YR27"
...
void loop() {
  ...
  midSensor = midSensor / 15;
  if (sendThingPost(ThingSpeakKEY, midSensor))
  { debug("Update Send");
    lcd.print(" Update:" + String(midSensor));
  }
  delay(1000);
}
...
//  String  Host = "api.thingspeak.com";
  ...
  success &= sendCom("AT+CIPSTART=\"TCP\",\"" + Host + "\",3000", "OK");
